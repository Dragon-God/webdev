...
<body>
	...
	<thead style="font-style: Times New Roman; font-size: 36px; color: #000080; background-color: #00ff00">
		<tr><th colspan="3"><b><i>The Fibonacci Sequence</i></b></th></tr>
	</thead>
	<tfoot style="font-style: Times New Roman; font-size: 24px; color: #000080">
		<tr><th colspan="3">Courtesy of Dragon God</th></tr>
	</tfoot>
	<tbody>
<?php
	define("SEED1", 0);
	...
	print "<tr><td align=\"center\">0</td><td>".SEED1."</td><td></td></tr><tr><td align=\"center\">1</td><td>".SEED2."</td><td></td></tr>";
	$count = 2;
...
*/		
		if($num > 0)
		{
			$var1 += $var2;
			$var2 += $var1;
			print "<tr><td align=\"center\">$count</td><td>".$var1."</td><td>".__CLASS__."</td></tr>";
			$count++;
			print "<tr><td align=\"center\">$count</td><td>".$var2."</td><td>".__METHOD__."</td></tr>";
			$count++;
			$num -= 2;
			fibonacci($num) ;
		}
